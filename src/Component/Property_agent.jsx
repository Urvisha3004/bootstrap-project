                ...
                <div className="row ">
                    <div className="col-lg-6 container d-flex justify-content-center m-auto">
                        <div className="Slider_text">
                            <h1 style={{ fontWeight: 'bold', color: '#0E2E50', fontSize: '50px' }}>Property Agent</h1>
                            <div className="fs-4">
                                <Breadcrumb>
                                    ...
                                    <Breadcrumb.Item active>PROPERTY AGENT</Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
                        </div>
                    </div>
