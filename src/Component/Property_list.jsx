...
import Property_Listing from './Property_Listing';
                ...
                <div className="row ">
                    <div className="col-lg-6 container d-flex justify-content-center m-auto ">
                        <div className="Slider_text ">
                            <h1 style={{ fontWeight: 'bold', color: '#0E2E50', fontSize: '50px' }}>Property List</h1>
                            <div className="fs-5 ">
                                <Breadcrumb>
                                    ...
                                    <Breadcrumb.Item active>PROPERTY LIST</Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
